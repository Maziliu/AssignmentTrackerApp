...
const String createProflieTable = '''
...
CREATE TABLE IF NOT EXISTS "course" (
  ...
  FOREIGN KEY ("profile_id") REFERENCES "$profileTableName" ("id"),
  FOREIGN KEY ("graded_component_id") REFERENCES "$gradedComponentTableName" ("id"),
  FOREIGN KEY ("grade_scale_id") REFERENCES "$gradeScaleTableName" ("id"),
);''';

const String assesmentTableName = 'assesment';
String createAssesmentTable = '''
CREATE TABLE IF NOT EXISTS "$assesmentTableName" (
  "id" INTEGER NOT NULL PRIMARY KEY AUTOINCREMENT,
  "course_id" INTEGER NOT NULL,
  "graded_component_id" INTEGER NOT NULL,
  "assesment_name" TEXT NOT NULL,
  "type" NOT NULL CHECK ("type" IS IN (${AssesmentType.allAssesmentTypes})),
  "is_complete" INTEGER NOT NULL DEFAULT 0,
  FOREIGN KEY ("course_id") REFERENCES "$courseTableName" ("id"),
  FOREIGN KEY ("graded_component_id") REFERENCES "$gradedComponentTableName" ("id")
)''';
